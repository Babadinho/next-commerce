...
const Category = ({ title, icon, onClick, className }: Props) => {
  return (
    ...
    >
      <a
        className={`relative w-20 h-20 md:w-40 md:h-40 rounded-full flex items-center justify-center transition-all duration-300 bg-white ease text-slate-700 hover:text-slate-800`}
      >
        {icon}
      </a>
