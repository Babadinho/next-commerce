...
const Category = ({ title, icon, onClick, className }: Props) => {
  return (
    ...
    >
      <a
        className={`relative z-30 w-20 h-20 md:w-40 md:h-40 rounded-full flex items-center justify-center transition-all duration-300 bg-[#E7ECEE] ease text-slate-600 hover:text-slate-800`}
      >
        {icon}
      </a>
